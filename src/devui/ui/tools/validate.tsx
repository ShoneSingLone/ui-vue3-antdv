 ...
 * @returns
 */
export async function validateForm(configsForm: any, valuesCollection?: Object) {
...
export const checkXItem = async ({ xItemConfigs, fnCheckedCallback, value, FormItemId }: any) => {
