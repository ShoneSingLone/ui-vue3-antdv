...
(function(global2, factory) {
  ...
  const _hoisted_2$8 = /* @__PURE__ */ vue.createElementVNode("path", { d: "M448 128a64 64 0 1 0 128 0 64 64 0 1 0-128 0ZM257.1 180.5a61.3 61.3 0 1 0 122.6 0 61.3 61.3 0 1 0-122.6 0ZM121.8 318.4a58.7 58.7 0 1 0 117.4 0 58.7 58.7 0 1 0-117.4 0ZM72 512a56 56 0 1 0 112 0 56 56 0 1 0-112 0Zm55.2 193.6a53.3 53.3 0 1 0 106.6 0 53.3 53.3 0 1 0-106.6 0Zm140.5 137.9a50.7 50.7 0 1 0 101.4 0 50.7 50.7 0 1 0-101.4 0ZM464 896a48 48 0 1 0 96 0 48 48 0 1 0-96 0Zm196.3-52.5a45.3 45.3 0 1 0 90.6 0 45.3 45.3 0 1 0-90.6 0Zm140.5-137.9a42.7 42.7 0 1 0 85.4 0 42.7 42.7 0 1 0-85.4 0ZM856 512a40 40 0 1 0 80 0 40 40 0 1 0-80 0ZM837.9 377.7a33.8 33.8 0 1 0 67.6 0 33.8 33.8 0 1 0-67.6 0Zm-61.5-113.5a28.3 28.3 0 1 0 56.6 0 28.3 28.3 0 1 0-56.6 0ZM680 180a24 24 0 1 0 48 0 24 24 0 1 0-48 0Z" }, null, -1);
  const _hoisted_3$8 = /* @__PURE__ */ vue.createElementVNode("animateTransform", {
    additive: "sum",
  ...
  function render$8(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$8, _hoisted_4);
  }
  ...
  const _hoisted_2$3 = /* @__PURE__ */ vue.createElementVNode("path", { d: "M512 128c212 0 384 172 384 384S724 896 512 896 128 724 128 512s172-384 384-384m0-64C264.8 64 64 264.8 64 512s200.8 448 448 448 448-200.8 448-448S759.2 64 512 64zm32 704h-64v-64h64v64zm11.2-203.2-5.6 4.8c-3.2 2.4-5.6 8-5.6 12.8v58.4h-64v-58.4c0-24.8 11.2-48 29.6-63.2l5.6-4.8c56-44.8 83.2-68 83.2-108 0-48-38.4-86.4-86.4-86.4-49.6 0-86.4 36.8-86.4 86.4h-64c0-84 66.4-150.4 150.4-150.4 83.2 0 150.4 67.2 150.4 150.4 0 72.8-49.6 112.8-107.2 158.4z" }, null, -1);
  const _hoisted_3$3 = [
    _hoisted_2$3
  ];
  ...
  const Input = vue.defineComponent({
    ...
    methods: {
      diffComponent(type) {
        ...
        const ComponentInstance = vue.resolveComponent(type);
  ...
  const LayerUtils = {
    ...
    alert(content, options, yes) {
      var isOptionsIsFn = _.isFunction(options);
      if (isOptionsIsFn) {
        yes = options;
      }
    ...
    msg(content, options, end = () => null) {
      var isOptionsIsFn = _.isFunction(options), rskin = READY.config.skin;
...
<div id="${_IDLayer}" layer-wrapper="${_IDLayer}" type="${typeName}"
    ...
    initConfig(custumSettings) {
      ...
      layerInstance.config.onClickClose = async (params) => {
        const isFalse = (val) => _.isBoolean(val) && !val;
...
<iframe class="layui-layer-load flex flex1" 
    ...
    insertLayer() {
      ...
      if (_.isObject(config.content) && (_.isString(config.content) || _.isString(config.content.jquery))) {
