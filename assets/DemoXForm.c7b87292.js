...
\`\`\`
`}}},J={class:"mr10"},M={class:"flex middle mt10"},Y={class:"mr10"},z={class:"mr10"},H={class:"flex middle mt10"},K={class:"mr10"},Q=m("div",{class:"mt10"},null,-1);function Z(e,o,l,g,a,T){const k=s("xButton"),_=s("mkit"),h=s("xItem"),y=s("aCard"),N=s("DemoXFormWithForm");return L(),P(S,null,[t(y,null,{default:w(()=>[U(p(T.valueFromConfigs)+" ",1),t(k,{configs:a.configsValidBtn},null,8,["configs"]),t(_,{md:a.tips1},null,8,["md"]),m("span",J,p(a.formData.inputValue),1),t(h,{configs:a.xForm.search,class:"flex1",modelValue:a.formData.inputValue,"onUpdate:modelValue":o[0]||(o[0]=x=>a.formData.inputValue=x)},null,8,["configs","modelValue"]),t(_,{md:a.tips2},null,8,["md"]),m("div",M,[m("span",Y,p(a.xForm.slots.value),1),t(h,{configs:a.xForm.slots,class:"flex1"},null,8,["configs"]),m("span",z,p(a.xForm.slotsAddonBefore.value),1)]),m("div",H,[m("span",K,p(a.xForm.select.value),1),t(h,{configs:a.xForm.select,class:"flex1"},null,8,["configs"])]),t(h,{configs:a.xForm.withLabelProperty,class:"flex1",modelValue:a.formData.inputValue,"onUpdate:modelValue":o[1]||(o[1]=x=>a.formData.inputValue=x)},null,8,["configs","modelValue"])]),_:1}),Q,t(y,null,{default:w(()=>[t(N,{options:{payload:{row:{}}}})]),_:1})],64)}const te=R(O,[["render",Z]]);export{te as default};
