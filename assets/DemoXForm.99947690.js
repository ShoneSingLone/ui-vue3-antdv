import{p as u,E as n,S as F,g as t,r as s,d as q,b as m,v as C,A as S,F as T,_ as R,k as h,m as E,U as v,o as L,f as P,w as I,l as U,h as i,i as j,t as d}from"./index.252523a4.js";const{$t:A}=F,p=!1,f=!0,W={email:()=>/^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/,mobile:()=>/^1[34578]\d{9}$/},V=e=>(e.trigger=e.trigger||[n.update],e.msg=e.msg||"",e),g={SUCCESS:p,FAIL:f,required(e,a=[n.update]){return V({name:"required",msg:e||A("\u5FC5\u586B\u9879").label,async validator(l){return l?u.isArray(l)?l.length>0?p:f:p:u.isBoolean(l)||u.isNumber(l)&&!u.isNaN(l)?p:f},trigger:a})},demo(){return{name:"Demo",msg:"Demo",async validator(e){return await u.sleep(1e3),f},trigger:[n.update,n.input,n.change,n.blur]}},email(){return{name:"email",msg:()=>A("\u8BF7\u8F93\u5165email").label,async validator(e){return W.email().test(e)?p:f},trigger:[n.update,n.input,n.change,n.blur]}},custom({name:e,msg:a,validator:l,trigger:c}){return V({name:e,msg:a,validator:l,trigger:c})}},B=e=>u.reduce(e,(a,l,c)=>{try{a[c]=JSON.parse(JSON.stringify(l.value))}catch{}return a},{}),O={labelTips:e=>(a,l)=>{const{prop:c,label:o}=a;return t("div",{class:"ant-form-item-label"},[t("label",{for:c,class:l},[o,t(s("aPopover"),{trigger:"hover"},{content:()=>e,default:()=>t(s("xIcon"),{icon:"Insidetips",class:"pointer"},null)})])])}},{$t:D}=F,$=q({props:{options:{type:Object,default(){return{}}}},data(){const{row:e}=this.options.payload||{},{name:a,age:l}=e||{};return{tips1:'### \u81EA\u5B9A\u4E49form \u5BBD\u5EA6\uFF0Clabel\u5BBD\u5EA6\uFF0C\u5C45\u4E2D\n```html\n<xForm class=\\"flex vertical\\" :labelStyle="State.styleForm">\n```\n```js\nconsole.log(window)\n//\n```',styleForm:{width:"120px","text-align":"right"},row:e||{},dataXItem:{...m({value:a||"\u65B0\u589E",label:D("name").label,prop:"name",rules:[g.required()]}),...m({value:l||0,label:D("age").label,prop:"age",rules:[g.required()]})}}},methods:{async verifyForm(){const e=await C(this.dataXItem);return S(e)},getParams(){return{...this.row,...this.data}}},render(){return t("div",{id:"DialogModifyIP"},[t(s("xForm"),{class:"flex vertical",labelStyle:this.styleForm},{default:()=>[t(s("aAlert"),{message:this.$t("\u63D0\u793A\u4FE1\u606F").label,type:"info"},null),u.map(this.dataXItem,e=>t(T,null,[t(s("xGap"),{t:"10"},null),t(s("xItem"),{configs:e},null)]))]}),t(s("mkit"),{md:`### \u81EA\u5B9A\u4E49form \u5BBD\u5EA6\uFF0Clabel\u5BBD\u5EA6\uFF0C\u5C45\u4E2D
\`\`\`js
...
\`\`\`
`}}},M={class:"mr10"},Y={class:"flex middle mt10"},z={class:"mr10"},H={class:"mr10"},K={class:"flex middle mt10"},Q={class:"mr10"},Z=i("div",{class:"mt10"},null,-1);function ee(e,a,l,c,o,N){const _=s("DemoAndCode"),k=s("xButton"),y=s("mkit"),x=s("xItem"),w=s("aCard"),X=s("DemoXFormWithForm");return L(),P(T,null,[t(_,{title:"xItem\u57FA\u672C\u7528\u6CD5",path:"/boundless/demo/xForm/DialogDemoXItem.sfc"}),t(_,{title:"xItem\u7279\u6B8Aslot",path:"/boundless/demo/xForm/xItemSlot.sfc"}),t(w,null,{default:I(()=>[j(d(N.valueFromConfigs)+" ",1),t(k,{configs:o.configsValidBtn},null,8,["configs"]),t(y,{md:o.tips1},null,8,["md"]),i("span",M,d(o.formData.inputValue),1),t(x,{configs:o.xForm.search,class:"flex1",modelValue:o.formData.inputValue,"onUpdate:modelValue":a[0]||(a[0]=b=>o.formData.inputValue=b)},null,8,["configs","modelValue"]),t(y,{md:o.tips2},null,8,["md"]),i("div",Y,[i("span",z,d(o.xForm.slots.value),1),t(x,{configs:o.xForm.slots,class:"flex1"},null,8,["configs"]),i("span",H,d(o.xForm.slotsAddonBefore.value),1)]),i("div",K,[i("span",Q,d(o.xForm.select.value),1),t(x,{configs:o.xForm.select,class:"flex1"},null,8,["configs"])]),t(x,{configs:o.xForm.withLabelProperty,class:"flex1",modelValue:o.formData.inputValue,"onUpdate:modelValue":a[1]||(a[1]=b=>o.formData.inputValue=b)},null,8,["configs","modelValue"])]),_:1}),Z,t(w,null,{default:I(()=>[t(X,{options:{payload:{row:{}}}})]),_:1})],64)}const te=R(G,[["render",ee]]);export{te as default};
